...
# 进度区域尺寸
SCHEDULE_WIDTH = RESOURCE_RIGHT - ZONING_RIGHT - 5
...
INPUT_BOTTOM = INPUT_TOP + INPUT_HEIGHT

# 信息框尺寸
INFORMATION_WIDTH = SCHEDULE_WIDTH
INFORMATION_HEIGHT = WORLD_HEIGHT - SCHEDULE_HEIGHT

# 信息框坐标
INFORMATION_LEFT = SCHEDULE_LEFT
INFORMATION_RIGHT = SCHEDULE_RIGHT
INFORMATION_TOP = MESSAGE_BOX_TOP
INFORMATION_BOTTOM = INPUT_BOTTOM
